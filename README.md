# VelOrda Bicycle Rental Admin Dashboard

Server-side rendered admin panel for managing bicycle rental operations
...
- [Assets Folder](assets/) - CSV data files and bicycle images
